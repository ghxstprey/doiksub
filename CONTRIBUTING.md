...
doiksub is a community project and welcomes any kind of contribution from anyone!
...
## Improve doiksub itself

If you have any ideas on how to improve doiksub itself, or want to propose a new plugin API, feel free to open a feature request so we can discuss.
...
We have an open support channel in our Discord community.
