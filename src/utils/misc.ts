...
import { doiksubDevsById, DevsById } from "./constants";
...
export const isPluginDev = (id: string) => Object.hasOwn(DevsById, id) || Object.hasOwn(doiksubDevsById, id);

export const shouldShowContributorBadge = (id: string) => {
    if (Object.hasOwn(DevsById, id))
        return DevsById[id].badge !== false;
    if (Object.hasOwn(doiksubDevsById, id))
        return doiksubDevsById[id].badge !== false;
    return false;
};
