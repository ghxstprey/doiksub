    ...
    return (
        <section className={Margins.top16}>
            ...
            <Forms.FormText className={Margins.bottom8}>
                Settings for Notifications sent by doiksub.
    ...
    return (
        <>
            ...
            <Forms.FormText className={Margins.bottom8}>
                ...
                <ul>
                    <li><strong>doiksub Notifications</strong>: These are in-app notifications</li>
            ...
            <Select
                ...
                options={[
                    ...
                    { label: "Always use doiksub notifications", value: "never" },
